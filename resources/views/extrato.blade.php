...
<div class="row">
        ...
        <div class="card mb-4">
            ...
            <div class="card-footer">
                ...
                <form method="POST" action="{{route('deletar',[$receita->id])}}" class="d-inline">
                    @csrf
                    @method('DELETE')
                    <button type="submit" onClick="if(!confirm('Tem certeza que deseja excluir?')){return false}" class=" btn btn-link"><i class="fa-regular fa-trash-can"></i></button>
                </form>
    ...
    <div class="col-md-6 p-3">
        <h2>Despesas R$ {{number_format($totDespesas->valor, 2, ',', '.')}} </h2>
