    ...
    <div class="col-md-12 p-3">
       <form method="POST" action="{{route('atualiza')}}">
        ...
        <div class="form-check form-check-inline">
            <input class="form-check-input" required type="radio" name="tipo" id="tipo" value="despesas" @if($movimento->tipo == 'despesas') checked @endif>
          ...
          <div class="mb-3">
            ...
            <input type="number" required name="valor" id="valor" class="form-control" step="0.1" value ="{{$movimento->valor}}">
          </div>
