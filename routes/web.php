...
Route::middleware([
    ...
    //Rota Nova Entrada - cadastro de receita ou despesas 
  ...
  //Rotas para o UPDATE - U do CRUD - uma rota para o formulario de atualização
